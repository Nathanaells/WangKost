        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="flex gap-4">
                            <Link href="/login" className="px-6 py-2.5 text-gray-700 hover:text-[#5353ec] font-semibold transition-colors">
                                Login
                            </Link>
                            <Link
                                href="/register"
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <p className="text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                            All-in-one platform to manage rooms, tenants, payments, and grow your hostel business with powerful automation
                            and insights.
                        </p>
                        <p className="text-sm text-gray-500 mt-6">Free forever plan available</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 max-w-5xl mx-auto">
                        ...
                        <div className="text-center">
                            <div className="text-4xl font-bold text-[#5353ec] mb-2">99.9%</div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Powerful features designed to simplify your hostel management and boost your revenue
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                description: 'Real-time room availability tracking with automated status updates and occupancy analytics.',
                                color: 'purple',
                            },
                            {
                                icon: '👥',
                                title: 'Tenant Management',
                                description: 'Complete tenant profiles with rental history, documents, and automated lease management.',
                                color: 'green',
                            },
                            {
                                icon: '💰',
                                title: 'Payment Processing',
                                description: 'Automated rent collection, payment reminders, and integrated payment gateway support.',
                                color: 'yellow',
                            },
                            {
                                icon: '📊',
                                title: 'Analytics & Insights',
                                description: 'Comprehensive reports on occupancy, revenue, and business performance with trend analysis.',
                                color: 'red',
                            },
                            {
                                icon: '🔔',
                                title: 'Smart Notifications',
                                description: 'Automated alerts for rent dues, lease renewals, and important business events.',
                                color: 'indigo',
                            },
                        ].map((feature, index) => (
                            <div
            ...
            <section className="py-32 px-4 sm:px-6 lg:px-8 bg-linear-to-brr from-[#5353ec] via-[#7c3aed] to-[#5353ec] text-white">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-5xl md:text-6xl font-bold mb-8">Ready to Transform Your Business?</h2>
                    <p className="text-2xl mb-12 text-purple-100 max-w-3xl mx-auto">
                        Join thousands of hostel owners who are already managing their properties efficiently with WangKost
                    </p>
                    <div className="flex items-center justify-center gap-8 mt-16 text-purple-100">
            ...
            <footer className="bg-gray-900 text-white py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="text-gray-400 text-lg mb-6 max-w-md">
                                The most comprehensive hostel management platform built for modern property owners in Indonesia.
                            </p>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-3 text-gray-400">
                                <li>
                                    <Link href="/login" className="hover:text-white transition-colors text-lg">
                                        Features
                                    </Link>
                                </li>
                                <li>
                    ...
                    <div className="border-t border-gray-800 pt-10 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-400 text-lg">&copy; 2025 WangKost. All rights reserved.</p>
