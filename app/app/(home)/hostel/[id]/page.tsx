...
=======
  ...
  isAvailable: boolean;
  tenant: ITenant | null;
>>>>>>> 8388924f1eb3fc5382b6cd084740a12afd309205
}
...
>>>>>>> 8388924f1eb3fc5382b6cd084740a12afd309205
  ...
  const handleSubmitTenant = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const tenantsListResponse = await fetch(`${url}/api/tenants`);
      const tenantsList = await tenantsListResponse.json();
      const createdTenant = tenantsList.find(
        (t: string) => t.email === formData.email
      );
      ...
      const roomUpdateResponse = await fetch(
        `${url}/api/hostels/${hostelId}/rooms/${selectedRoom._id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      console.error(error);
      toast.error((error as string) || "Failed to add tenant");
    }
  };
                ...
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Rp {room.fixedCost?.toLocaleString("id-ID") || 0}/month
                    </p>
                  </div>
                  <span
                ...
                {!room.isAvailable && room.tenant ? (
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Since:{" "}
                      {new Date(room.tenant.joinDate).toLocaleDateString(
                        "id-ID"
                      )}
                    </p>
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
            <h3 className="text-xl font-bold text-gray-900 mb-4">
              Add Tenant to Room {selectedRoom?.roomNumber}
            </h3>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Rp {selectedRoom.price.toLocaleString("id-ID")}/month
                </p>
              </div>
              <button
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">
                    {selectedRoom.tenant.email}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Phone</p>
                  <p className="font-medium text-gray-900">
                    {selectedRoom.tenant.phoneNumber}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Join Date</p>
                  <p className="font-medium text-gray-900">
                    {new Date(selectedRoom.tenant.joinDate).toLocaleDateString(
                      "id-ID"
                    )}
                  </p>
                </div>
            ...
            <div className="mb-6">
              ...
              <div className="mt-4 bg-blue-50 p-4 rounded-lg">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-medium text-gray-900">
                    Rp{" "}
                    {selectedRoom.tenant.additionals
                ...
                <div className="border-t border-blue-200 pt-2 mt-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-blue-600 text-lg">
                      ...
                      {(
                        selectedRoom.price +
                        selectedRoom.tenant.additionals.reduce(
