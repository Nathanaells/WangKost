    ...
    return (
        <div className="p-4 pt-20 sm:ml-64 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto pt-6">
                {/* Back Button */}
                <div className="mb-6">
                    <Link href="/hostel" className="text-blue-600 hover:underline mb-4 inline-flex items-center gap-2">
                        <svg
                                ...
                                <Link
                                    ...
                                    <div className="text-gray-600 text-sm">
                                        <div className="flex justify-between">
                                            <span>Price:</span>
                                            <span className="font-semibold">Rp {room.fixedCost.toLocaleString('id-ID')}</span>
                                        </div>
                                    </div>
                                </Link>
                            ))}
