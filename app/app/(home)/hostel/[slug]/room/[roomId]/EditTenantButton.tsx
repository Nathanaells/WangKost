...
export default function EditTenantButton({ tenant, slug, roomId }: EditTenantButtonProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.name || !formData.email || !formData.phoneNumber || !formData.birthday) {
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-gray-800">Edit Tenant Information</h2>
                                <button
