...
async function getDashboardData() {
  try {
    ...
    const hostels: IHostel[] = hostelsResponse.ok
      ? await hostelsResponse.json()
      : [];
    const tenants: ITenant[] = tenantsResponse.ok
    ...
    // Calculate monthly income from successful transactions (PAID)
    ...
    return {
      ...
      occupancyRate,
      totalTenants,
      monthlyRevenue: monthlyIncome, // Using successful transaction amounts
    };
  } catch (error) {
    ...
    <div className="p-4 pt-20 sm:ml-64 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto pt-6">
        ...
        <div className="mb-6">
          <Link
            href="/tenants"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            <svg
            ...
            <span className="font-semibold">View All Tenants</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="flex justify-center gap-6 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">
                  Available ({data.totalRooms - data.occupiedRooms})
                </span>
              </div>
            </div>
          </div>
